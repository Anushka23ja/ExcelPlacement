      ...
      <div class="container">
        <div class="row">
          <!--<div class="col-lg-6 about-img">-->
           ...
           <div class="bg">
          <div align="center" class="col-lg-6 content">
		  <h1><font color="#000000">user-Login</font></h1>
		  <center>
            <form method="post" action="userquery.php">
			
			
<ul class="form-style-1">
   <label><font size="+1" color="#000000"><b>User Name</b></font><span class="required">*</span></label>
   <input type="text" name="field1" style="height:30px; width:300px;" class="field-long
	...
	<th><lable><input type="submit" value="Submit" name="Submit" class="btn btn-primary" Onclick="return demo();"/></lable></th>

		<th><lable><input type="submit" value="Cancel" class="btn btn-primary" hspace="100px" /></label></center></th>
