  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body"><font size="+3">Excel Placement Consultancy</span></a></h1>
...
<tr>
 ...
 <tr>  
   ...
   <tr>
    ...
    <!--<tr>
        <th><br />Date</th>
        <td><input type="date" name="field4"  class="field-long" style="height:30px; width:300px;" /></td>
		</tr>-->
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<td><br /><input type="submit" value="Cancel" class="btn btn-primary" hspace="100px" /></td>
    </tr>
