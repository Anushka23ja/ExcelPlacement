...
-->            <!--<img src="img/stock-vector-consulting-logo-for-business-775177780.jpg" />-->
          </div>
          <div class="box">
...
-->               
    ...
    about-us" placeholder="Old Password" id="field1" style="height:30px; width:350px" /></td></tr>
                    <!--<input type="text" name="field2" class="field-divided" placeholder="Last" />-->
                  <tr>
                  <th><font size="+3">.</font></th>
                    <td><br /><input type="password"name="field2"  id="field2"class="field-long" placeholder="New Password" style="height:30px; width:350px"></td>
                  </tr>
                  
                  <tr>
                     <th><font size="+3">.</font></th>
                    <td><br /><input type="password" name="field4"  id="field4"class="field-long" placeholder="Confirm Password" style="height:30px; width:350px"></td>
                  </tr>
