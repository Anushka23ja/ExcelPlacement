...
dt=document.getElementById("txtdt").value;
total=document.getElementById("field4").value;
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto"><font size="+3">Excel Placement Consultancy</span></font></a></h1>
...
-->                
		   <font size="+1">
            <table align="center">
              ...
              <form method="post" action="paymentquery.php">
    ...
    about-us" placeholder="" id="field1" style="height:30px; width:350px" /></td></tr>
                  ...
                  <tr>
                   ...
                   <!-- <th><br />
                      Date</th>
                    <td><br /><input type="date" name="field3"  id="txtdt"class="field-long" style="height:30px; width:350px"></td>
                  </tr>-->
