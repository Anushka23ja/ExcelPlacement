  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="userhome.php">Back</a></li>
 ...
 <!-- <section id="intro">
  ...
  <main id="main">
    ...
    about-us" placeholder="" id="field1" style="height:30px; width:300px;" /></td>
                 ...
                 <td><a href="upresume1.php"><u><font color="#000000"><input type="button" name="up" value="Upload your resume here" class="btn btn-primary" /></font></u></a>
                  </tr>
                </ul>
              </form>
            </table>
...
//insert
/* $q1="insert into canreg values($id,'$nm','$add','$cn','$eml','$quali','$extra','$exp',$sallry)";*/
