    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        ...
        <!--<li class="menu-active"><a href="index.html">Home</a></li>-->
          ...
          --><li><a href="newcompany1.php">back</a></li>
...
{
 /*$q="select * from comreg where cmpytyp='$sel1'";
 $res=mysql_query($q);*/
...
?>
<form id="frm1" action="newcompany.php">
<br /><input type="submit" name="submit" value="Back" align="middle" />
</form>
